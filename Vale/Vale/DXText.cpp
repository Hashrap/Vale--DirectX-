...
// Create DirectX Font
//=============================================================================
bool DXText::initialize(ValeGraphics *g, int height, bool bold, bool italic, LPWSTR fontName)
{
...
// post: spriteEnd()
//=============================================================================
int DXText::print(const std::string &str, int x, int y)
{
    if(dxFont == NULL)
        return 0;
    // set font position
...
// post: spriteEnd()
//=============================================================================
int DXText::print(const std::string &str, RECT &rect, UINT format)
{
    if(dxFont == NULL)
        return 0;
